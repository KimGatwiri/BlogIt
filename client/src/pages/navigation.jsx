...
function Navigation() {
  const navigate = useNavigate();
    ...
    return (
        ...
        <div className='flex gap-96 '>
            <div className="text-4xl font-medium flex items-center" onClick={handleHomeClick}>
            <RiQuillPenFill/>
          <p>Blog</p>
  ...
  >
    My Profile
                ...
                <button className="login bg-blue-400 text-gray-50 rounded p-2 " onClick={handleLoginClick}>Login</button>
                <button className="signup bg-blue-800 text-gray-50 rounded p-2 " onClick={handleSignupClick}>Signup</button>
                </div>
