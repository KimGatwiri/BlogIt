  ...
  return (
    ...
    >
      ...
      <div className="flex-col relative flex items-center justify-center h-full text-white z-10">
        <h1 className="m-3.5 text-white text-7xl font-bold">Welcome To BlogIt</h1>
        ...
        <div className=' m-3.5 flex gap-10 text-xl '>
                <button className=" bg-blue-500 hover:bg-blue-200 text-gray-50 hover:text-gray-900 rounded-2xl p-3 " onClick={handleLoginClick}>Start Writing</button>
                <button className=" bg-blue-800 hover:bg-blue-200 text-gray-50  hover:text-gray-900 rounded-2xl  p-3 " onClick={handleSignupClick}>Explore stories</button>
                </div>
      </div>
